...
| [`ObeliskVaultFactory`](src/ObeliskVaultFactory.sol) | Anyone can create a vault with their own policy hash. Shares the verifier, registry and program key across vaults. |
...
- A real Groth16 proof from the policy program, verified by Succinct's verifier contract
